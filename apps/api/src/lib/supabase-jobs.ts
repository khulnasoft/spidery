...
/**
 * Get a single spidery_job by ID
...
/**
 * Get multiple spidery_jobs by ID. Use this if you're not requesting a lot (50+) of jobs at once.
...
/**
 * Get multiple spidery_jobs by crawl ID. Use this if you need a lot of jobs at once.

...
export interface SpideryScrapeResponse {
  statusCode: number;
  body: {
    status: string;
    data: Document;
...
export interface SpideryCrawlResponse {
  statusCode: number;
  body: {
    status: string;
    jobId: string;
...
export interface SpideryCrawlStatusResponse {
  statusCode: number;
  body: {
    status: string;
    data: Document[];
...
export interface SpideryExtractResponse {
  statusCode: number;
  body: {
    success: boolean;
    data: any[];

...
describe("E2E Tests for v1 API Routes", () => {
  ...
  describe("POST /v1/scrape", () => {
    ...
    it.concurrent(
      ...
      async () => {
        ...
        expect(response.body.data).toHaveProperty("metadata");
        expect(response.body.data.links).toContain(
  ...
  describe("POST /v1/map", () => {
    ...
    it.concurrent(
      ...
      async () => {
        const mapRequest = {
          url: "https://www.spidery.khulnasoft.com",
          search: "docs",
          includeSubdomains: true,
        };
  ...
  describe("POST /v1/crawl", () => {
    ...
    it.concurrent(
      ...
      async () => {
        ...
        urls.forEach((url: string) => {
          expect(url).toContain("spidery.khulnasoft.com/blog");
        });
    ...
    it.concurrent(
      ...
      async () => {
        ...
        urls.forEach((url: string) => {
          expect(
            url.startsWith("https://www.spidery.khulnasoft.com/blog/"),
          ).toBeFalsy();
        });
      },
      90000,

    ...
    try {
      ...
      if (!creditsCheckSuccess) {
        ...
        return res.status(402).json({
          error:
            "Insufficient credits. For more credits, you can upgrade your plan at https://spidery.khulnasoft.com/pricing",
        });
      }
    } catch (error) {
      logger.error(error);
      ...
      return res.status(500).json({
        error:
          "Error checking team credits. Please contact help@spidery.com for help.",
      });
    }

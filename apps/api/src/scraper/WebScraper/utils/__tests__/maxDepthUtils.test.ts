...
describe("Testing getURLDepth and getAdjustedMaxDepth", () => {
  it("should return 0 for root - khulnasoft.com", () => {
    const enteredURL = "https://www.khulnasoft.com/";
  ...
  it("Adjusted maxDepth should return 0 for khulnasoft.com and max depth param of 0", () => {
    const enteredURL = "https://khulnasoft.com";
    expect(getAdjustedMaxDepth(enteredURL, 0)).toBe(0);
  });

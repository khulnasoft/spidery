...
def get_version():
    ...
    version_file = (this_directory / "spidery" / "__init__.py").read_text()
...
setup(
    name="spidery-py",
    version=get_version(),
    url="https://github.com/khulnasoft/spidery",
    author="Khulnasoft.com",
    author_email="nick@khulnasoft.com",
    description="Python SDK for Spidery API",

...
app = SpideryApp(api_key="fc-")

# Scrape a website:
scrape_result = app.scrape_url('spidery.khulnasoft.com')
...
async_result = app.async_crawl_url('spidery.khulnasoft.com', {'excludePaths': ['blog/*']}, "")
print(async_result)
...
app2 = SpideryApp(api_key="fc-", version="v0")
...
# Map a website:
map_result = app.map_url('https://spidery.khulnasoft.com', { 'search': 'blog' })
print(map_result)
...
extract_result = app.extract(['https://spidery.khulnasoft.com'], {

...
If you're contributing, note that the process is similar to other open source repos i.e. (fork spidery, make changes, run tests, PR). If you have any questions, and would like help gettin on board, reach out to help@spidery.com for more or submit an issue!
...
```bash
pnpm run workers
# if you are going to use the [llm-extract feature](https://github.com/khulnasoft/spidery/pull/586/), you should also export OPENAI_API_KEY=sk-______
```

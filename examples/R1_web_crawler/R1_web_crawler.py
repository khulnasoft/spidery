...
def extract_company_info(urls, prompt, company, api_key):
    ...
    print(f"{Colors.YELLOW}Extracting structured data from the provided URLs using Spidery's /extract endpoint...{Colors.RESET}")
    app = SpideryApp(api_key=os.getenv("SPIDERY_API_KEY"))
    try:

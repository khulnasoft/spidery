...
python .github/scripts/check_version_has_incremented.py js ./apps/js-sdk/spidery @khulnasoft/spidery-js 
Local version: 0.0.22
Published version: 0.0.21
true

python .github/scripts/check_version_has_incremented.py python ./apps/python-sdk/spidery spidery-py 
